...
describe BibleMetadata do
  ...
  describe '#book_names' do
    it "should have 26 books" do
      BibleMetadata.book_names.should have(66).books
    end
    it "should return Genesis first" do
      BibleMetadata.book_names.first.should == 'Genesis'
    end

    it "should return Revelation last" do
      BibleMetadata.book_names.last.should == 'Revelation'
    end
  end
